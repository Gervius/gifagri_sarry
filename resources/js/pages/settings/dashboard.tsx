            ...
            <div className="container mx-auto px-4 py-8">
                <div className="mb-8">
                    ...
                    <p className="mt-2 text-gray-600">
                        Centre de contrôle de l'ERP - Gérez tous les paramètres
                        de votre entreprise
                    </p>
                </div>
                ...
                >
                    <TabsList className="grid w-full grid-cols-4">
                        <TabsTrigger value="company">
                            Entreprise & Infrastructures
                        </TabsTrigger>
                        <TabsTrigger value="zootechnie">
                            Zootechnie & Santé
                        </TabsTrigger>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    ...
                                    votre entreprise et ses infrastructures
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <CompanySettings />
                    ...
                    <TabsContent value="zootechnie" className="mt-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Gérez les plans prophylactiques et les
                                    protocoles de santé animale
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <ZootechnieSante />
                    ...
                    <TabsContent value="finance" className="mt-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Structurez vos comptes analytiques et
                                    centres de coût
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                    ...
                    <TabsContent value="security" className="mt-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Gérez les rôles et permissions des
                                    utilisateurs
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
